...
fn main() { 
    ...
    contacts.insert("Alejandra", "821-5423");
    contacts.insert("Maria Ines", "821-5423");
    contacts.insert("Christina", "212-9321");
    contacts.insert("Papo", "312-3429");
